...
explainableAV/Amazon/SS_test.json  explainableAV/Amazon/SS_val.json  explainableAV/Amazon/SS_train.json
explainableAV/Amazon/SD_test.json  explainableAV/Amazon/SD_val.json  explainableAV/Amazon/SD_train.json 
explainableAV/Amazon/DS_test.json  explainableAV/Amazon/DS_val.json  explainableAV/Amazon/DS_train.json 
explainableAV/Amazon/DD_test.json  explainableAV/Amazon/DD_val.json  explainableAV/Amazon/DD_train.json
explainableAV/Amazon/test_set_15000x4.json explainableAV/Amazon/val_set_15000x4.json explainableAV/Amazon/train_set_15000x4.json
...
```
This will create the following files:
explainableAV/PAN20/SS_test.json  explainableAV/PAN20/SS_val.json  explainableAV/PAN20/SS_train.json
explainableAV/PAN20/SD_test.json  explainableAV/PAN20/SD_val.json  explainableAV/PAN20/SD_train.json 
explainableAV/PAN20/DS_test.json  explainableAV/PAN20/DS_val.json  explainableAV/PAN20/DS_train.json 
explainableAV/PAN20/DD_test.json  explainableAV/PAN20/DD_val.json  explainableAV/PAN20/DD_train.json
explainableAV/PAN20/test_set_2500x4.json explainableAV/PAN20/val_set_2500x4.json explainableAV/PAN20/train_set_2500x4.json
Where the last line combines all pair types into one test, val or train dataset
